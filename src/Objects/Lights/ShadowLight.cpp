...
void ShadowLight::updateTransformationMatrix()
{
	...
	this->worldToClipMatrix = glCamera->getCameraToClipMatrix()*worldToCameraMatrix;
	Singleton<GLState>::Instance()->shadowLightWorldToClipMatrix = this->worldToClipMatrix;
}